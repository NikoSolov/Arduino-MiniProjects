...
//    }
  ...
  lcd.print("SD...");
  lcd.setCursor(11, 2);
  if (SD.begin()) {lcd.println("started");}
...
*/
////////////////////////////////////////////////////////////
if (digitalRead(3) && !(digitalRead(2))){mode=true;}
else if (digitalRead(2) && !(digitalRead(3))){mode=false;}
else if (state && !(digitalRead(2)) && !(digitalRead(3))){
  if (mode){a--;}
  else{a++;}
  state=false;
}
else if (!state && digitalRead(2)==1 && digitalRead(3)==1){
  state=true;}
///////////////////////////////////////////////////////////////
  //////////LCD OUT////////////////

//  if ((millis() - lcdmillis) > 250) {
    Serial.println("LCD");
    lcdmillis = millis();
    lcd.setCursor(0, 0);
